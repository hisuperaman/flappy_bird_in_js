const dieSFX = new Audio("sfx/sfx_die.wav")
const hitSFX = new Audio("sfx/sfx_hit.wav")
const pointSFX = new Audio("sfx/sfx_point.wav")
const wingSFX = new Audio("sfx/sfx_wing.wav")


const bird_imgs = [new Image(), new Image(), new Image()];
const bird_img_paths = ["sprites/bird-midflap.png", "sprites/bird-downflap.png", "sprites/bird-upflap.png"]
...
topPipe_img.src = "sprites/top_pipe.png";
bottomPipe_img.src = "sprites/bottom_pipe.png";

const background_img = new Image();
background_img.src = "sprites/background.jpg"
